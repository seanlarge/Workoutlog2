...
class MovementsControllerTest < ActionController::TestCase
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post :create, movement: { description: @movement.description, equipment: @movement.equipment, name: @movement.name }
    end
  ...
  test "should update movement" do
    patch :update, id: @movement, movement: { description: @movement.description, equipment: @movement.equipment, name: @movement.name }
    assert_redirected_to movement_path(assigns(:movement))
  end
